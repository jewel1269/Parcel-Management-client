...
const Dashboard = () => {
  ...
  return (
    <div className="lg:flex">
      <aside className="flex flex-col w-64 h-screen px-4  overflow-y-auto bg-gray-50 rounded-xl shadow-xl border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        ...
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav>
            ...
            >
              ...
              <span className="mx-4 font-medium">My Profile menu </span>
            </a>
            <a
