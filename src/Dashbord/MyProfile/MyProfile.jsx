      ...
      {user ? (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
          <div className="bg-white rounded-lg shadow-lg p-8 flex flex-col items-center w-full max-w-4xl">
            <div className="text-start py-2 rounded-md mb-4">
              <span className="text-black uppercase underline font-semibold text-2xl ">
                My Profile
              </span>
            </div>
            {/* Profile Header */}
            <div className="w-full flex flex-col md:flex-row items-center md:items-start">
              <div className="w-full md:w-1/3 flex justify-center md:justify-start mb-4 md:mb-0">
                <img
                  src={userInfo[0]?.image || userInfo?.image || user?.photoURL}
                  alt="Profile"
              ...
              <div className="w-full md:w-2/3 flex flex-col items-center md:items-start">
                ...
                <p className="text-lg text-gray-600">
                  <strong>Role:</strong> {userInfo[0]?.role || userInfo?.role}
                </p>
              </div>
            </div>
            ...
            <div className="w-full flex flex-col md:flex-row mt-8">
              <div className="w-full md:w-1/3">
                <form action="">
                  <input type="file" name="UpdateImage" id="" />
                  <button className="btn mt-1 btn-xs border border-gray-400">
                    Update
                  </button>
                </form>
        ...
        <h1 className="text-4xl text-center font-semibold lg:mt-32 text-orange-500 animate__animated animate__backInUp">
          Your are not a user
          <br />
          <span className="text-2xl uppercase underline text-black">
